<?php
    ...
    $valor = $_POST['valor'];
    $cliente = $_POST['nome_fantasi'];
    $escala = $_POST['escala'];

    $result = "INSERT INTO contratos (numero,  posto_trabalho, valor, nome_fantasi, escala) VALUES ('$numero',  '$posto_trabalho', '$valor', '$cliente', '$escala')";
