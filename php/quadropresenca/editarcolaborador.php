...
<body>
    ...
    <form method="POST" action="peditarcolaborador.php">
        ...
        <?php
                ...
                $dnumero = 'd' . $n3;
                while ($n3<=date('d')){
                    if  ($linha_colaborador[$dnumero] == 'P' || $linha_colaborador[$dnumero] == 'E') {
                        echo "<td class='branco'><input type='text' class='quadro' name='$n3' value=$linha_colaborador[$dnumero] ></td>";
                        $n3++;
                        $dnumero = 'd' . $n3;
                    }
                    else if ($n3 == date('d')){
                        echo "<td class='branco'><input type='text' class='quadro' name='$n3' value=''></td>";
                        $n3++;
                        $dnumero = 'd' . $n3;
                    }
                    else{
                        echo "<td class='branco'><input type='text' class='quadro' name='$n3' value='F'></td>";
                        $n3++;
                        $dnumero = 'd' . $n3;
                    }
                }
